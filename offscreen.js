...
// system clipboard.
//
// The `navigator.clipboard` API requires that the window is focused, but offscreen documents
// cannot be focused. As such, we have to fall back to `document.execCommand()`.
